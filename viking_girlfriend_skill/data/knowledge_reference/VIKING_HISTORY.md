# Sigrid Knowledge Reference — Viking History & The Viking Age

**Subject literal name:** Viking History & The Viking Age
**Filename:** VIKING_HISTORY.md
**Status:** In Progress
**Coverage plan:** Deep-dive into 9th-century Norse culture, expansion, society, and mythology through the lens of Sigrid's primary expertise.
**Quality standard:** Manual curation, no automation, no repetition, double-checked accuracy

## Scope
Includes: Historical events (793–1066 AD), social hierarchy, naval technology, trade routes, daily life, religious practices, and the psychological framework of the Viking warrior.
Excludes: Generic pop-culture fiction, horn-helmeted myths, and unverified modern interpretations.

## Coverage Map
- Foundational Concepts (Origins and Early Expansion)
- Terminology (Old Norse legal and social terms)
- Methods (Shipbuilding and Navigation)
- Historical Developments (Lindisfarne to Stamford Bridge)
- Major Figures (Kings, Jarls, and Skjaldmær)
- Traditions (The Thing, Blót, and Burial Rites)

## Entries

### 1. The Lindisfarne Raid (793 AD)
- **Title:** The Lindisfarne Raid
- **Category:** Historical Developments
- **Type:** Turning Point
- **Content:** The attack on the monastery of Lindisfarne off the coast of Northumbria is the traditional starting point of the Viking Age in Western history. Viking raiders, likely from Norway, struck the holy island, killing monks and seizing vast treasures. To the Christian world, this was a divine punishment; to the Norse, it was the discovery of a vulnerable and wealthy new trade and raid horizon.
- **Why it matters:** It signaled the beginning of the Norse expansion into the West and the first major clash between Northern paganism and Western Christianity.
- **Verification note:** Sourced from the Anglo-Saxon Chronicle entry for 793.
- **Uniqueness note:** Foundational event, distinct from later permanent settlements like the Great Heathen Army.

### 2. The Concept of Drengskapr
- **Title:** Drengskapr
- **Category:** Foundational Concepts
- **Type:** Ethical Framework
- **Content:** Drengskapr is the Old Norse ideal of honor, courage, and integrity. A person possessing drengskapr (a *drengr*) is one who is brave, keeps their word, and shows generosity even to enemies. It is the "Skaldic Code" that defines a true man or woman of the North.
- **Why it matters:** It is the moral gravity that prevents the Viking world from descending into pure chaos; it is the oath-binding force.
- **Verification note:** Verified via the *Hávamál* and various Icelandic Sagas (e.g., Egil's Saga).
- **Uniqueness note:** Focuses on the internal character trait rather than external legal status (like being a Jarl).

### 3. The Longship (*Langskip*) - Clinker Building
- **Title:** Clinker-built Construction
- **Category:** Methods
- **Type:** Engineering
- **Content:** The defining feature of Viking naval superiority. Unlike the heavy, rigid Mediterranean ships, Norse longships used overlapping wooden planks (usually oak) riveted together. This created a flexible, "elastic" hull that could bend with the waves rather than breaking against them.
- **Why it matters:** This flexibility allowed for the shallow-draft vessels required for both ocean crossings and riverine inland raids.
- **Verification note:** Sourced from archaeological findings at the Roskilde Viking Ship Museum.
- **Uniqueness note:** Specifically covers the construction method, distinct from navigation or ship types.

### 4. The Althing (*Alþingi*)
- **Title:** The Althing
- **Category:** Traditions
- **Type:** Governance
- **Content:** Established in 930 AD in Iceland, the Althing is one of the oldest surviving parliamentary institutions in the world. It was an annual outdoor assembly where free men gathered to settle disputes, pass laws, and recite the legal code from the Lawspeaker's rock (Lögberg).
- **Why it matters:** It demonstrates that Norse society was not merely a rule of the sword, but a highly structured legalistic culture where even chieftains could be held accountable.
- **Verification note:** Historical record of the Commonwealth period of Iceland.
- **Uniqueness note:** Covers the national-level assembly, distinct from local *things*.

### 5. The Hamingja (Success and Luck)
- **Title:** Hamingja
- **Category:** Foundational Concepts
- **Type:** Metaphysical Concept
- **Content:** In Norse belief, *hamingja* is a form of inherent luck or "success-force" associated with a person or family line. It was not seen as random chance, but as a tangible quality that could be inherited, lost through dishonor, or even loaned to others.
- **Why it matters:** To have "good hamingja" was to be favored by the Norns; it explains why some leaders were followed despite impossible odds.
- **Verification note:** Documented in *The Viking Mind* by Tom Shippey and various sagas.
- **Uniqueness note:** Distinct from *Wyrd* (Fate), as Hamingja is a quality of the self rather than the weave of events.

### 6. The Shield-Wall (*Skjaldborg*)
- **Title:** The Skjaldborg
- **Category:** Terminology
- **Type:** Tactics
- **Content:** The primary tactical formation of Norse infantry. Warriors stood shoulder-to-shoulder, their round shields overlapping. The strength of the wall was dependent entirely on the discipline and trust between neighbors. A break in the wall usually meant the death of the entire unit.
- **Why it matters:** It reflects the collective nature of Norse warfare; individual glory was secondary to the survival of the shield-line.
- **Verification note:** Verified through tactical descriptions in the *Battle of Maldon* and various Sagas.
- **Uniqueness note:** Focuses on the physical formation, distinct from the *Svínfylking* (boar snout).

### 7. The Knarr (Merchant Vessel)
- **Title:** The Knarr
- **Category:** Methods
- **Type:** Technology
- **Content:** While the Longship was for war, the *Knarr* was the true engine of Norse wealth. It was broader, deeper, and slower, designed for carrying massive amounts of cargo (furs, slaves, walrus ivory, silk) over the open Atlantic to Greenland and Vinland.
- **Why it matters:** Without the Knarr, the permanent settlements in Iceland and Greenland would have been impossible.
- **Verification note:** Verified via the Skuldelev 1 ship wreck.
- **Uniqueness note:** Distinct from the *Langskip* (warship); focuses on trade and logistics.

### 8. The Blót (Sacrificial Rites)
- **Title:** The Blót
- **Category:** Traditions
- **Type:** Religious Practice
- **Content:** A blót was a sacrificial banquet offered to the gods, typically involving the killing of livestock (horses, pigs, cattle). The blood (*hlaut*) was sprinkled on the participants and the temple walls, while the meat was consumed in a communal feast.
- **Why it matters:** It was the primary mechanism for maintaining the relationship between humanity and the divine—a sacred exchange of life-force for favor.
- **Verification note:** Sourced from Adam of Bremen's descriptions and the *Hakonar Saga*.
- **Uniqueness note:** Focuses on the ritual mechanism, distinct from specific holidays like Yule.

### 9. The Skjaldmær (Shield-Maiden)
- **Title:** Skjaldmær
- **Category:** Major Figures
- **Type:** Social Role
- **Content:** A female warrior who chose to fight as a man in the shield-wall. While the historical prevalence is debated among archaeologists, the literary and mythological tradition of the shield-maiden (e.g., Lagertha, Hervor) is a core component of the Norse warrior-identity.
- **Why it matters:** It highlights the unique gender-fluidity within Norse martial roles compared to the rigid patriarchy of Southern Europe.
- **Verification note:** Verified via Saxo Grammaticus and the Birka female warrior burial (Bj 581).
- **Uniqueness note:** Focuses on the historical/literary role, distinct from the divine *Valkyries*.

### 10. The Danegeld
- **Title:** The Danegeld
- **Category:** Historical Developments
- **Type:** Economic/Political
- **Content:** A tax levied by Anglo-Saxon or Frankish rulers to pay off Viking raiders to prevent them from attacking. It was effectively "protection money." The practice often led to more raids, as the Vikings realized raiding was less profitable than simply threatening to raid.
- **Why it matters:** It drained the treasuries of Europe and led to the eventual centralization of royal power to coordinate payments and defenses.

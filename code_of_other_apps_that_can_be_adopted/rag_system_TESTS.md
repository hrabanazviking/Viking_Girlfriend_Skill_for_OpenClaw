...
@pytest.fixture
def instance():
    return RagSystem(data_path="tests/data")
...
```bash
# All tests
python -m pytest tests/unit/test_rag_system.py -v

# With coverage
python -m pytest tests/unit/test_rag_system.py --cov=systems.rag_system

# Specific test
python -m pytest tests/unit/test_rag_system.py::test_basic_operation -v
```

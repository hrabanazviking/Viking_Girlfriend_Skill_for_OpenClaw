...
### Unit Tests
```python
# tests/unit/test_alfheim.py
import pytest
from yggdrasil.worlds.alfheim import Alfheim

@pytest.fixture
def instance():
    return Alfheim(data_path="tests/data")
...
```bash
# All tests
python -m pytest tests/unit/test_alfheim.py -v

# With coverage
python -m pytest tests/unit/test_alfheim.py --cov=yggdrasil.worlds.alfheim

# Specific test
python -m pytest tests/unit/test_alfheim.py::test_basic_operation -v
```

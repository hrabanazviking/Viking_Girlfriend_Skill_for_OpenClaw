...
### Unit Tests
```python
# tests/unit/test_jotunheim.py
import pytest
from yggdrasil.worlds.jotunheim import Jotunheim

@pytest.fixture
def instance():
    return Jotunheim(data_path="tests/data")
...
```bash
# All tests
python -m pytest tests/unit/test_jotunheim.py -v

# With coverage
python -m pytest tests/unit/test_jotunheim.py --cov=yggdrasil.worlds.jotunheim

# Specific test
python -m pytest tests/unit/test_jotunheim.py::test_basic_operation -v
```

...
### Unit Tests
```python
# tests/unit/test_bifrost.py
import pytest
from yggdrasil.core.bifrost import Bifrost

@pytest.fixture
def instance():
    return Bifrost(data_path="tests/data")
...
```bash
# All tests
python -m pytest tests/unit/test_bifrost.py -v

# With coverage
python -m pytest tests/unit/test_bifrost.py --cov=yggdrasil.core.bifrost

# Specific test
python -m pytest tests/unit/test_bifrost.py::test_basic_operation -v
```

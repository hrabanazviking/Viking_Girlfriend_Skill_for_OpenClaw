...
### Unit Tests
```python
# tests/unit/test_world_tree.py
import pytest
from yggdrasil.core.world_tree import WorldTree

@pytest.fixture
def instance():
    return WorldTree(data_path="tests/data")
...
```bash
# All tests
python -m pytest tests/unit/test_world_tree.py -v

# With coverage
python -m pytest tests/unit/test_world_tree.py --cov=yggdrasil.core.world_tree

# Specific test
python -m pytest tests/unit/test_world_tree.py::test_basic_operation -v
```

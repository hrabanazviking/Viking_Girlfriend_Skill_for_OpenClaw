...
import pytest
from yggdrasil.router import Router

@pytest.fixture
def instance():
    return Router(data_path="tests/data")
...
# With coverage
python -m pytest tests/unit/test_router.py --cov=yggdrasil.router

# Specific test
python -m pytest tests/unit/test_router.py::test_basic_operation -v
```

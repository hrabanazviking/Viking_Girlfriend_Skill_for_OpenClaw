...
@pytest.fixture
def instance():
    return Openrouter(data_path="tests/data")
...
```bash
# All tests
python -m pytest tests/unit/test_openrouter.py -v

# With coverage
python -m pytest tests/unit/test_openrouter.py --cov=ai.openrouter

# Specific test
python -m pytest tests/unit/test_openrouter.py::test_basic_operation -v
```
